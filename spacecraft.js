...
const currentCoordinates = () => ({x:12,y:23,z:34});
console.log(currentCoordinates());

/* Task 4: Understanding `this`: Message from Home Base */
// TODO: Inside an object named `spacecraft`, create a method named `receiveMessage` using arrow function syntax. 
const spacecraft = {
    receiveMessage:(message) =>{console.log(`Message received: ${this.message}`)} 
};
spacecraft.receiveMessage('hii');
/*This method should log `"Message received: "` followed by a message it receives as a parameter. 
Directly call `receiveMessage` within `spacecraft` and observe. Observe and explain the behavior of `this` in this context as a 
comment.
 * Observations:
 * TODO: Explain here.
 */
